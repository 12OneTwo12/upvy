...
import me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY
...
class UserViewHistoryRepositoryTest : AbstractIntegrationTest() {
    ...
    private fun saveViewHistory(
        ...
        Mono.from(dslContext.insertInto(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY)
            .set(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY.USER_ID, userId.toString())
            .set(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY.CONTENT_ID, contentId.toString())
            .set(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY.WATCHED_AT, watchedAt)
            .set(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY.WATCHED_DURATION, watchedDuration)
            .set(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY.COMPLETION_RATE, completionRate)
            .set(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY.CREATED_AT, watchedAt)
            .set(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY.CREATED_BY, userId.toString())
            .set(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY.UPDATED_AT, watchedAt)
            .set(me.onetwo.upvy.jooq.generated.tables.references.USER_VIEW_HISTORY.UPDATED_BY, userId.toString())).block()
    }
}
