 ...
 *
 * 백엔드 API 스펙과 100% 일치:
 * - upvy-backend/src/main/kotlin/me/onetwo/upvy/domain/search/dto/
 * - upvy-backend/src/main/kotlin/me/onetwo/upvy/domain/search/model/
 */
...
/**
 * 검색 정렬 기준
 * 백엔드: me.onetwo.upvy.domain.search.model.SearchSortType
 */
export type SearchSortType = 'RELEVANCE' | 'RECENT' | 'POPULAR';

/**
 * 검색 타입
 * 백엔드: me.onetwo.upvy.domain.search.model.SearchType
 */
export type SearchType = 'CONTENT' | 'USER';

/**
 * 난이도 레벨
 * 백엔드: me.onetwo.upvy.domain.content.model.DifficultyLevel
 */
export type DifficultyLevel = 'BEGINNER' | 'INTERMEDIATE' | 'ADVANCED';

/**
 * 자동완성 제안 타입
 * 백엔드: me.onetwo.upvy.domain.search.dto.SuggestionType
 */
