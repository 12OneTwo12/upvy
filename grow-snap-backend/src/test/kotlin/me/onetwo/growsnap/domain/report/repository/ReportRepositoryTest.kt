...
class ReportRepositoryTest : AbstractIntegrationTest() {
    ...
    fun tearDown() {
        ...
        Mono.from(dslContext.deleteFrom(me.onetwo.growsnap.jooq.generated.tables.UserProfiles.Companion.USER_PROFILES)).block()
        Mono.from(dslContext.deleteFrom(me.onetwo.growsnap.jooq.generated.tables.Users.Companion.USERS)).block()
    }
