...
class VertexAiLlmClient(
    ...
    private fun buildSearchQueryPrompt(context: SearchContext): String {
        ...
        |
        |**콘텐츠 다양성 원칙 (매우 중요!):**
        |1. **균형잡힌 카테고리 믹스**: Hard Skills(프로그래밍, 재테크, 역사, 언어 등)와 Soft Skills(동기부여, 마인드셋, 심리학 등)를 50:50 비율로 균형있게 생성
        |2. **동기부여/자기계발/라이프스타일 우선**: 이런 콘텐츠도 중요한 교육 콘텐츠입니다
        |   - 동기부여, 습관 형성, 목표 달성, 생산성, 시간 관리
        |   - 자기계발, 마인드셋, 심리학, 인간관계
        |   - 건강, 운동, 다이어트, 명상
        |   - 재미있는 과학, 역사 이야기, 예술, 여행
